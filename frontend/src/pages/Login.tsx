  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-center bg-gray-950 relative">
      ...
      <div
       ...
       overflow-hidden"
      >
        <div className="circle absolute -top-20 -right-10 w-52 h-52 rounded-full bg-red-300/20  -z-0"></div>
        ...
        <p className="mt-4">
          ...
          <NavLink to={"/register"} className="text-emerald-500 cursor-pointer">
            &nbsp; Sign Up
          </NavLink>{" "}
        </p>
      </div>
